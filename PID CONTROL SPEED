//motor interrupt
#define interruptA_1 18
#define interruptB_1 19

#define interruptA_2 20
#define interruptA_2 21

// motor control pins
const int motorDir_1 = 8; //L298N IN1 motor 1
const int motorPWM_1 = 9; //L298N IN2 motor 1
const int motorDir_2 = 10; //L298N IN3 motor 2
const int motorPWM_2 = 11; //L298N IN4 motor 2
